...
ignoredFiles=(
  ...
  "./directory/parks/index.html"
  "./directory/performing-arts/index.html"
  "./directory/restaurants/index.html"
  "./directory/websites/index.html"
)
...
for i in "${filenames[@]}"; do
  if [[ ! " ${ignoredFiles[*]} " =~ " ${i} " ]]; then
      ...
      echo "    <loc>https://alexanderburdiss.com$path</loc>" >> $sitemapfile
